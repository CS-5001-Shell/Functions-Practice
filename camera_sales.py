...
In this example we are going to calculate the salary of a camera salesperson. Their basic salary is 1500, for every camera they will sell they will get 200 and the commission on the month’s sale is 2%. The input will be number of cameras sold and total price of the cameras.
